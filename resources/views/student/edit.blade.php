    ...
    <div style="width: 400px" class="mx-auto">
        <form action="{{route('student.update')}}" method="POST"  enctype="multipart/form-data">
            ...
            <div class="form-group">
                <img id="imagePreview" src="{{$student ? asset('storage/' . $student->image) : '#' }}" alt="Image Preview" style="{{$student->image ? 'display:block; width: 200px; height: auto;' :' display:none; width: 200px; height: auto;'}}" />
            </div>
